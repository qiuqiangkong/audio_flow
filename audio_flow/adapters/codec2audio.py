...
class Codec2AudioAdapter(nn.Module): 
    def __init__(self, vocab: int, dim: int, **kwargs):
        super().__init__()
        ...
        # Latent
        self.latent_fc = nn.Embedding(vocab, dim)
    ...
    def forward(self, data: dict) -> Tensor:
        ...
        # Latent
        input_latent = self.latent_fc(data["input_latent"].long())  # (b, l, d)
