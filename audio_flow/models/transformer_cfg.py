...
class Transformer03a(nn.Module):
    def __init__(
        self,
        in_dim=16,
        dim=384,
        ...
        **kwargs
        ...
        self.null_c = nn.Parameter(torch.randn(in_dim))  # (d,)
        # self.null_seq = nn.Parameter(torch.randn((1, dim)))  # (1, d)
...
class Transformer03b(nn.Module):
    def __init__(
        self,
        in_dim=16,
        dim=384,
